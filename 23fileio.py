...
# 파일을 통해 값을 입력,출력 할 수 있고
# 심지어, 네트워크를 통해 값을 입력,출력 할 수도 있음

# 프로그램 실행중 생성된 데이터(변수)들은
# 주로 메모리 내에 존재하는데, 프로그램 종료 시 같이 소멸됨(휘발성)
# 이러한 데이터에 영속성persistence을 부여하여면
# 데이터를 저장장치에 보관해서
...
# hello2.txt에 '안녕, 세상아'라는 내용을 저장한 파일 생성
